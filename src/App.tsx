        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24">
          ...
          <div className="w-full md:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="aspect-square bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-500 group">
               <img src="/regenerated_image_1777499856191.jpg" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Portfolio 1" referrerPolicy="no-referrer" />
            </div>
            <div className="aspect-square bg-white rounded-3xl overflow-hidden shadow-sm sm:mt-12 hover:shadow-xl transition-shadow duration-500 group">
               <img src="/regenerated_image_1777499857474.jpg" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Portfolio 2" referrerPolicy="no-referrer" />
            </div>
          </div>
        </div>
      </section>
